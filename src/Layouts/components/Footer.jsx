...
const Footer = () => {
  return (
    <div className="pt-10">
      <div className="flex justify-center bg-cover bg-[url('https://www.huxtaburger.com.au/wp-content/themes/HUXTA/images/Navy_Footer.svg')] bg-cyan-200 text-blue-400">
